...
final class Version20250531151939 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create initial database schema for the application with Campaign, Favorite, ImgScenario, Music, Rating, Scenario, and User entities.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favorite (id INT AUTO_INCREMENT NOT NULL, scenario_id INT NOT NULL, user_id INT NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_68C58ED9E04E49DF (scenario_id), INDEX IDX_68C58ED9A76ED395 (user_id), UNIQUE INDEX UNIQ_FAVORITE_USER_SCENARIO (user_id, scenario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, scenario_id INT NOT NULL, user_id INT NOT NULL, score SMALLINT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D8892622E04E49DF (scenario_id), INDEX IDX_D8892622A76ED395 (user_id), UNIQUE INDEX UNIQ_RATING_USER_SCENARIO (user_id, scenario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
